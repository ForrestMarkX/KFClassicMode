class ClassicSM_Player_Emote extends KFSM_Player_Emote;

static function byte PackFlagsBase( KFPawn P )
{
    return class'ClassicEmoteList'.static.GetEmoteIndex( class'ClassicEmoteList'.static.GetEquippedEmoteId(ClassicPlayerController(P.Controller)) );
}

function PlayAnimation()
{
    AnimName = class'ClassicEmoteList'.static.GetEmoteFromIndex( KFPOwner.SpecialMoveFlags );
