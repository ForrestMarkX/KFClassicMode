...
defaultproperties
{
    ...
    ZEDArchList.Add((MonsterClass=class'KFPawn_ZedMatriarch', Regular=KFCharacterInfo_Monster'ZED_ARCH.ZED_Matriarch_Archetype', Summer=KFCharacterInfo_Monster'ZED_ARCH.ZED_Matriarch_Archetype', Winter=KFCharacterInfo_Monster'XMAS_ZED_ARCH.ZED_Matriarch_Archetype', Fall=KFCharacterInfo_Monster'ZED_ARCH.ZED_Matriarch_Archetype'))
